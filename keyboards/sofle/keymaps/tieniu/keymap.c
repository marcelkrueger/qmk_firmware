...
//),
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX, KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  MT(KC_RCTL,KC_ESC),                             
              OSM_LALT,OSM_LGUI, OSM_RSFT, KC_RAISE, OSM_LCTL,    OSM_LCTL, KC_LOWER, OSM_RSFT, OSM_LGUI, OSM_RALT
),
